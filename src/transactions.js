 ...
 * @param {HDSigner#createSigners} parameters.createSigners An **async** function that returns an array of signer functions. One for each utxo. Signer functions sign the hash of the transaction.
 * @param {HDSigner#getPublicKey} parameters.getPublicKey An **async** function that resolves the public key from a derivation path and the network.
